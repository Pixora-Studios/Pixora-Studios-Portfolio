...
export const metadata = constructMetadata({
  ...
  description: "Explore fixed, tiered, repeatable digital offerings by Pixora Studios. Ready-to-use business tools including Digital QR Menu and upcoming platforms.",
  canonical: "/products",
});
